      ...
      <div className={styles.index}>
        <div className={styles.div}>
          <div className={styles.overlap}>
            ...
            <select className={styles.overlapgroup} onChange={handleSelectChange1}>
            ...
            <input className={styles.rectangle} type="text" ref={titulo} placeholder="Digite aqui o título do evento" />
           
            <input className={styles.rectangle1} type="text" ref={palestrante} placeholder="Nome do(s) palestrante(s)" />
         
            <input className={styles.rectangle2} type="text" ref={local} placeholder="RDC" />
          
            <input className={styles.rectangle6} type="text" ref={codigoi} placeholder="Código de entrada" />
            
            <input className={styles.rectangle7} type="text" ref={codigof} placeholder="Código de saída" />
            
            <input className={styles.rectangle3} type="text" ref={link} placeholder="ecoa.puc-rio.br/eventos/21102023" />
      
            <input className={styles.rectangle4} type="text" ref={video} placeholder="ecoa.puc-rio.br/video/24102023" />
            ...
            <input className={styles.rectangle8} type="text" ref={detalhes} placeholder="Descrição do evento..." />
          
            <input className={styles.rectangle5} type="text" ref={inputRef} placeholder="Separe as tags com vírgula" />

            <input className={styles.imgfinal} type="file" accept="image/*" onChange={handleImageUpload} />
